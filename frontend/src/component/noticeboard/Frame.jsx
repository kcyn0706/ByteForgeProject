...
import VideoSearchBar from '../lecture/VideoSearch';
            ...
            <div className="noticeFrame">
                <header className="noticeFrameHeader">
                    ...
                    <div id="buttonArea">
                        ...
                        <span><Link to="/search" id="notDecor">강의</Link></span> 
                ...
                <Routes>
                    ...
                    <Route path='/search/*' element={<VideoSearchBar/>}/>
                </Routes>
            </div>
        </Fragment>
    )
